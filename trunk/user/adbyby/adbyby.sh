...
add_rules()
{
	...
	touch /tmp/md5.json && curl -k -s -o /tmp/md5.json --connect-timeout 5 --retry 3 https://raw.githubusercontent.com/kongfl888/ad-rules/master/md5.json
	...
	touch /tmp/lazy.txt && curl -k -s -o /tmp/lazy.txt --connect-timeout 5 --retry 3 https://raw.githubusercontent.com/kongfl888/ad-rules/master/lazy.txt
	touch /tmp/video.txt && curl -k -s -o /tmp/video.txt --connect-timeout 5 --retry 3 https://raw.githubusercontent.com/kongfl888/ad-rules/master/video.txt
